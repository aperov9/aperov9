...
- [berenddeboer/cdk-rds-sql](https://github.com/berenddeboer/cdk-rds-sql) ([v6.1.2](https://github.com/berenddeboer/cdk-rds-sql/releases/tag/v6.1.2), today) - A CDK construct that allows creating roles and databases an on Aurora Serverless Postgresql cluster.
